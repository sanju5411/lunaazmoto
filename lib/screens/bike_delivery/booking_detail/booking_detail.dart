              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                    ...
                    boxShadow: const [
                      BoxShadow(
                          color:
                              Color.fromRGBO(209, 255, 255, 0.5058823529411764),
                          blurRadius: 10),
                    ]),
                child: InkWell(
                  onTap: () {
                  ...
                  child: ListTile(
                      ...
                      leading: const CircleAvatar(
                        backgroundImage: NetworkImage(
                            "https://cdn.hswstatic.com/gif/play/0b7f4e9b-f59c-4024-9f06-b3dc12850ab7-1920-1080.jpg"), // No matter how big it is, it won't overflow
                      ),
                      title: Text(
                        "${bookingData.bookingUser?.name}",
                        style: const TextStyle(
                            fontWeight: FontWeight.w600, fontSize: 15),
                      ),
                      subtitle: Text(
                        "${bookingData.bookedDate}, ${bookingData.bookedTime}\nNewyork, United States\n${bookingData.bookingUser?.email}",
                        style: const TextStyle(
                      ...
                      trailing: Container(
                          ...
                          child: const Text(
                            "New Booking",
                            style: TextStyle(color: Color(0xFF1D3A70)),
                          ))),
                ),
              ),
            ),
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            if (bookingData.bookingAddress != null) ...[
                              Text(
                                "${bookingData.bookingAddress?.city},${bookingData.bookingAddress?.state}",
                                style: const TextStyle(
                                    fontSize: 13,
                                    color: CustomColor.whiteColor,
                                    fontWeight: FontWeight.w500),
                          ...
                          Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(
                                  "Select Type : ${bookingData.bookingPackage?.packageType} Service",
                                  style: TextStyle(
                                      color: Colors.grey,
                                      fontWeight: FontWeight.w600,
                                      fontSize: 15),
                          ...
                          Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(
                                  "Phone  :  ${bookingData.bookingUser?.countryCode}-${bookingData.bookingUser?.mobile}",
                                  style: TextStyle(
                                      color: Colors.grey,
                                      fontWeight: FontWeight.w600,
                                      fontSize: 15),
                          ...
                          Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                if (bookingData.bookingAddress != null) ...[
                                  Text(
                                    "City : ${bookingData.bookingAddress?.city}",
                                    style: TextStyle(
                                        color: Colors.grey,
                                        fontWeight: FontWeight.w600,
                                        fontSize: 15),
                                  ...
                                  Text(
                                    "Area : ${bookingData.bookingAddress?.state}",
                                    style: TextStyle(
                                        color: Colors.grey,
                                        fontWeight: FontWeight.w600,
                                        fontSize: 15),
                          ...
                          Row(
                            children: [
                              GestureDetector(
                                ...
                                child: Container(
                                  color:
                                      const Color.fromRGBO(96, 177, 14, 0.15),
                                  height: 40,
                                  width: 100,
                                  child: Padding(
